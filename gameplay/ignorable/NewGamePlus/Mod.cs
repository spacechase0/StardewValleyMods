    ...
    public class Mod : StardewModdingAPI.Mod
    {
        ...
        private void OnGameLaunched(object sender, GameLaunchedEventArgs e)
        {
            ...
            if (gmcm != null)
            {
                ...
                gmcm.AddNumberOption(ModManifest, () => Config.AdditionalProfitMultiplier, (x) => Config.AdditionalProfitMultiplier = x, () => I18n.Option_AdditionalProfit_Name(), () => I18n.Option_AdditionalProfit_Description(), 0.10f, 1f, 0.05f, (f) => (int)(f * 100) + "%");
                gmcm.AddNumberOption(ModManifest, () => Config.RelationshipPenaltyPercentage, (x) => Config.RelationshipPenaltyPercentage = x, () => I18n.Option_RelationshipPenalty_Name(), () => I18n.Option_RelationshipPenalty_Description(), 0f, 1.00f, 0.05f, (f) => (int)(f * 100) + "%");
