...
namespace ExtendedReach.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        /// <summary>Get a translation equivalent to "Wiggly Arms".</summary>
        public static string Config_WigglyArms_Name()
        {
            return I18n.GetByKey("config.wiggly-arms.name");
        }

        /// <summary>Get a translation equivalent to "Whether to show wiggly arms reaching out to your cursor.".</summary>
        public static string Config_WigglyArms_Tooltip()
        {
            return I18n.GetByKey("config.wiggly-arms.tooltip");
        }
