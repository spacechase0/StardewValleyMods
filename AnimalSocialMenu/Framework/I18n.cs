...
namespace AnimalSocialMenu.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        {
            return I18n.GetByKey("tab-tooltip");
        }

        /// <summary>Get a translation equivalent to "Needs petting".</summary>
        public static string NeedsPetting()
        {
            return I18n.GetByKey("needs-petting");
        }
