...
namespace DynamicGameAssets.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        /// <summary>Get a translation equivalent to "Mod: {{name}}".</summary>
        /// <param name="name">The value to inject for the <c>{{name}}</c> token.</param>
        public static string ItemTooltip_AddedByMod(object name)
        {
            return I18n.GetByKey("item-tooltip.added-by-mod", new { name });
        }
