...
namespace FlowerRain.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        /// <summary>Get a translation equivalent to "Use Vanilla Flowers Only".</summary>
        public static string Config_VanillaFlowersOnly_Name()
        {
            return I18n.GetByKey("config.vanilla-flowers-only.name");
        }

        /// <summary>Get a translation equivalent to "Whether to only use vanilla flowers in the flower rain.".</summary>
        public static string Config_VanillaFlowersOnly_Tooltip()
        {
            return I18n.GetByKey("config.vanilla-flowers-only.tooltip");
        }
