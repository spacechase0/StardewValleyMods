...
namespace GenericModConfigMenu.Framework
{
    ...
    public interface IGenericModConfigMenuApiWithObsoleteMethods : IGenericModConfigMenuApi
    {
        /*********
        ...
        *********/
        // Obsolete since 1.17.0
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddComplexOptionWithGamepadSupport) + " instead.")] void AddComplexOption(IManifest mod, Func<string> name, Action<SpriteBatch, Vector2> draw, Func<string> tooltip = null, Action beforeMenuOpened = null, Action beforeSave = null, Action afterSave = null, Action beforeReset = null, Action afterReset = null, Action beforeMenuClosed = null, Func<int> height = null, string fieldId = null);

        // Obsolete since 1.8.0
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddComplexOptionWithGamepadSupport) + " with more callback arguments instead.")] void AddComplexOption(IManifest mod, Func<string> name, Func<string> tooltip, Action<SpriteBatch, Vector2> draw, Action saveChanges, Func<int> height = null, string fieldId = null);
        ...
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddComplexOptionWithGamepadSupport) + " instead.")] void RegisterComplexOption(IManifest mod, string optionName, string optionDesc, Func<Vector2, object, object> widgetUpdate, Func<SpriteBatch, Vector2, object, object> widgetDraw, Action<object> onSave);
