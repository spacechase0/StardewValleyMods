...
namespace GenericModConfigMenu.Framework
{
    ...
    public class Api : IGenericModConfigMenuApiWithObsoleteMethods
    {
        ...
        *********/
        ...
        {
            this.DeprecationWarner($"{this.mod.UniqueID} (registering for {client?.UniqueID ?? "null client"}) is using deprecated code ({method}) that will break in a future version of GMCM.");
        }
    }
}
