...
namespace SpaceCore.VanillaAssetExpansion
{
    ...
    public class VAECustomCraftingIngredientMatcher : CustomCraftingRecipe.IngredientMatcher
    {
        ...
        public override string DispayName => StardewValley.TokenizableStrings.TokenParser.ParseText(data.OverrideText) ?? ItemRegistry.GetDataOrErrorItem(data.Value).DisplayName;
