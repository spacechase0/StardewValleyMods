...
namespace GenericModConfigMenu.Framework
{
    ...
    public interface IGenericModConfigMenuApiWithObsoleteMethods
    {
        ...
        *********/
        ...
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<bool> optionGet, Action<bool> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<int> optionGet, Action<int> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<float> optionGet, Action<float> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<string> optionGet, Action<string> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<SButton> optionGet, Action<SButton> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterSimpleOption(IManifest mod, string optionName, string optionDesc, Func<KeybindList> optionGet, Action<KeybindList> optionSet);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterClampedOption(IManifest mod, string optionName, string optionDesc, Func<int> optionGet, Action<int> optionSet, int min, int max);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterClampedOption(IManifest mod, string optionName, string optionDesc, Func<float> optionGet, Action<float> optionSet, float min, float max);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterClampedOption(IManifest mod, string optionName, string optionDesc, Func<int> optionGet, Action<int> optionSet, int min, int max, int interval);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterClampedOption(IManifest mod, string optionName, string optionDesc, Func<float> optionGet, Action<float> optionSet, float min, float max, float interval);
        [Obsolete("Use " + nameof(IGenericModConfigMenuApi.AddOption) + " instead.")] void RegisterChoiceOption(IManifest mod, string optionName, string optionDesc, Func<string> optionGet, Action<string> optionSet, string[] choices);
