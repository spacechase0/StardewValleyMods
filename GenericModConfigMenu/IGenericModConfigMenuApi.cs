...
namespace GenericModConfigMenu
{
        ...
        : IGenericModConfigMenuApiWithObsoleteMethods // DELETE THIS LINE WHEN COPIED INTO YOUR MOD CODE
    {
        ...
        ****/
        ...
        /// <param name="fieldId">The unique field ID for use with <see cref="OnFieldChanged"/>, or <c>null</c> to auto-generate a randomized ID.</param>
        void AddTextOption(IManifest mod, Func<string> getValue, Action<string> setValue, Func<string> name, Func<string> tooltip = null, string[] allowedValues = null, Func<string, string> formatAllowedValues = null, string fieldId = null);
