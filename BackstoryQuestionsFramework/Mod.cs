...
namespace BackstoryQuestionsFramework
{
    ...
    public static class FriendshipConstructorNetFieldInjection
    {
        ...
        {
            __instance.NetFields.AddFields(__instance.get_questionsAsked(), __instance.get_askedQuestionToday());
    ...
    public class Mod : StardewModdingAPI.Mod
    {
        ...
        {
            if (e.NameWithoutLocale.IsEquivalentTo("spacechase0.BackstoryQuestionsFramework/Questions"))
            {
        ...
        private void Asi_AdvancedInteractionStarted(object sender, Action<string, Action> e)
        {
            ...
            var data = Game1.content.Load<Dictionary<string, List<QuestionContentModel>>>("spacechase0.BackstoryQuestionsFramework/Questions");
                ...
                e(I18n.Question_Ask(), () =>
                {
                    ...
                    Game1.delayedActions.Add(new(0, () => Game1.currentLocation.afterQuestion = (farmer, answer) =>
                    {
                        ...
                        else
                        {
                            ...
                            Game1.activeClickableMenu = new DialogueBox(new Dialogue(q.AnswerText, npc));
                        };
                    }));
