...
namespace MoonMisadventures.Patches
{
    ...
    public static class MilkPailProduceGalaxyMilkPatch1
    {
        public static bool Prefix( MilkPail __instance, GameLocation location, int x, int y, Farmer who, ref bool __result, ref FarmAnimal ___animal )
        {
            ...
            if ( ___animal != null && ___animal.currentProduce.Value != null && ( int ) ___animal.age >= ( byte ) ___animal.ageWhenMature && ___animal.toolUsedForHarvest.Equals( __instance.BaseName ) && who.couldInventoryAcceptThisObject( ___animal.currentProduce, 1 ) )
            {
            ...
            else if ( ___animal != null && ___animal.currentProduce.Value != null && ( int ) ___animal.age >= ( byte ) ___animal.ageWhenMature )
            {
