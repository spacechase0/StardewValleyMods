...
namespace JumpOver.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        /// <summary>Get a translation equivalent to "Jump Key".</summary>
        public static string Config_JumpKey_Name()
        {
            return I18n.GetByKey("config.jump-key.name");
        }

        /// <summary>Get a translation equivalent to "The key to jump.".</summary>
        public static string Config_JumpKey_Tooltip()
        {
            return I18n.GetByKey("config.jump-key.tooltip");
        }
