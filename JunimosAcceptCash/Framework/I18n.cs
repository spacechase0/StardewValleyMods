...
namespace JunimosAcceptCash.Framework
{
    ...
    internal static class I18n
    {
        ...
        *********/
        ...
        /// <summary>Get a translation equivalent to "Cost Multiplier".</summary>
        public static string Config_CostMultiplier_Name()
        {
            return I18n.GetByKey("config.cost-multiplier.name");
        }

        /// <summary>Get a translation equivalent to "The multiplier for the cost of the items to charge.".</summary>
        public static string Config_CostMultiplier_Tooltip()
        {
            return I18n.GetByKey("config.cost-multiplier.tooltip");
        }
